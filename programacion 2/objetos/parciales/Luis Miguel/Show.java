public class Show {
    ...
    // constructores
        ...
        public Show( int numShow, Fecha fecha , boolean soldOut , Localidad[] localidades , int cantOcupadas ) {
    ...
    // setters
        public void setShow( int numShow ) { this.numShow = numShow ; }
        ...
        public void setCantLocalidades( int cantLocalidades ) { this.cantLocalidades = cantLocalidades ; }

        public void setCantOCupadas( int cantOCupadas ) { this.cantOCupadas = cantOCupadas ; }
    //
